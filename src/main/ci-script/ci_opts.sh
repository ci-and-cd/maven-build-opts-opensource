...
if [ -z "${CI_OPT_OPENSOURCE_NEXUS3}" ]; then CI_OPT_OPENSOURCE_NEXUS3="https://nexus3.infra.top/nexus/"; fi
# infrastructure oepnsource use https://sonarqube.com, CI_OPT_OPENSOURCE_SONAR_HOST_URL is not needed.
