...
if [ -z "${CI_OPT_OSSRH_GIT_PREFIX}" ]; then CI_OPT_OSSRH_GIT_PREFIX="https://github.com"; fi
...
if [ -z "${CI_OPT_OSSRH_NEXUS3}" ]; then CI_OPT_OSSRH_NEXUS3="https://nexus3.infra.top/nexus/"; fi
# infrastructure oepnsource use https://sonarqube.com, CI_OPT_OSSRH_SONAR_HOST_URL is not needed.
